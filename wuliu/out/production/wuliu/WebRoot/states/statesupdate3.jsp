    ...
    <div id="regdiv">
        ...
        <div class="box">
          <div class="box_border">
            <div class="box_top"><b class="pl15">派送详情</b></div>
            <div class="box_center">
               ...
               <tr>
                ...
                <tr>
                  <td class="td_right">订单提交时间:</td>
                  <td><input type="text" name="createtime"  value="${bean.createtime }" class="input-text lh30" size="40" readonly="readonly"/></td>
                </tr>
                
                <tr>
                  <td class="td_right">审核状况:</td>
                  <td><input type="text" name="audits"  value="${bean.audit.audits }" class="input-text lh30" size="40" readonly="readonly"/></td>
                </tr>
                
                <tr>
                  <td class="td_right">完成审核时间:</td>
                  <td><input type="text" name="createtime"  value="${bean.audit.createtime }" class="input-text lh30" size="40" readonly="readonly"/></td>
                </tr>
                
                <tr>
                  <td class="td_right">派送状况:</td>
                  <td><input type="text" name="send"  value="${bean.audit.states.send }" class="input-text lh30" size="40" readonly="readonly"/></td>
                </tr>
                
                
                <tr>
                  <td class="td_right">派送人员:</td>
                  <td><input type="text" name="truename"  value="${bean.audit.states.user.truename }" class="input-text lh30" size="40" readonly="readonly"/></td>
                </tr>
                
                <tr>
                  <td class="td_right">派送车辆:</td>
                  <td><input type="text" name="bianhao"  value="${bean.audit.states.car.bianhao }" class="input-text lh30" size="40" readonly="readonly"/></td>
                </tr>
                
                 <tr>
                  <td class="td_right">派送路线:</td>
                  <td><input type="text" name="loads"  value="${bean.audit.states.car.loads }" class="input-text lh30" size="40" readonly="readonly"/></td>
                </tr>
                
                <tr>
                  <td class="td_right">完成派送时间:</td>
                  <td><input type="text" name="endtime"  value="${bean.audit.states.endtime }" class="input-text lh30" size="40" readonly="readonly"/></td>
                </tr>
