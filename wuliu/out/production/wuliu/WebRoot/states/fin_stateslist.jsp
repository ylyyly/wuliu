...
<form action="method!fin_stateslist" method="post">
       <div class="box">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                ...
                <td><span style="color: red;">${bean.audit.states.send }</span></td>
                 <td>${bean.audit.states.user.truename }</td>
                  ...
                  <input type="button"  class="btn btn82 btn_config" value="派送"   onclick="location.href='method!fin_statesupdate?id=${bean.id }'"/>
                   </form>
                   </td>
                 </tr>
                 </c:forEach> 
