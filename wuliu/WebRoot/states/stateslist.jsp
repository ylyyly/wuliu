...
<form action="method!stateslist" method="post">
       <div class="box">
         ...
         <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="list_table">
                ...
                <td><span style="color: red;">${bean.audit.states.send }</span></td>
                 <td>${bean.audit.states.user.truename }</td>
                  <td>${bean.audit.states.car.bianhao }</td>
                   <td>  
                   <form name="form1" action="">
                  <input type="button"  class="btn btn82 btn_config" value="指派"   onclick="location.href='method!statesupdate?id=${bean.id }'"/>
                   </form>
                   </td>
                 </tr>
                 </c:forEach> 
